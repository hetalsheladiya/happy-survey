...
$("#sendQuery").on('click', function(){
	...
	var server = "https://"+window.location.hostname+"/hpysrvy.com";
	var email = $("#email").val();
	var message = $("#message").val();
	var name = $("#name").val();
	var data = {'email': email, 'message': message, 'name': name};
	// if(email == "" || message == "" || name == ""){
	// 	$('<div class="alert alert-warning alert-dismissible alert-form-check-fields" role="alert" style="display:block">'+
	// 			'<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>'+
	// 			'Please, fill in required fields.!'+
	// 		'</div>').insertBefore("#support");
	// }
	$.ajax({
           ...
           // },
            success: function(response){  
            	if(response.status == 'success'){ 
            		$('<div class="alert alert-success alert-dismissible alert-form-success" role="alert" style="display:block">'+
						'<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>'+
            		...
            		$('<div class="alert alert-danger alert-dismissible alert-form-error" role="alert" style="display:block">'+
						'<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>'+
						response.message +
					'</div>').insertBefore("#support");
            	}
