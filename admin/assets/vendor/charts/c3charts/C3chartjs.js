/*var sadCount = 0,
    neutralCount = 0,
    happyCount = 0,
    userId = document.getElementById("session").value;
function getDataSurvey(){    
    var dataToSend = "userId=" + userId;   
    $.ajax({
        url: "http://squareroot.us/surveyapp/surveycategoryresult.php",
        type: 'GET',
        data: dataToSend,
...
(function(window, document, $, undefined) {
    "use strict";
    $(function() {
        /*var happyCount = parseInt(sessionStorage.getItem("happyCount"));
        var neutralCount = parseInt(sessionStorage.getItem("neutralCount"));
        var sadCount = parseInt(sessionStorage.getItem("sadCount"));*/
